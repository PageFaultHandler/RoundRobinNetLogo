...
to generate-processes
  ...
  [
      ...
      ifelse random-work-time [set working-ticks random work-time] [set working-ticks work-time]
        set state "wait"
      ]
...
Line -16777216 false 120 120 180 180
Line -16777216 false 120 180 180 120
